...
function scroll_scroll() {
	...
	if (scr_items.length > 0) {
		for (let index = 0; index < scr_items.length; index++) {
			...
			let scr_item_point = window.innerHeight - (window.innerHeight - scr_item_height / 2.9);
			if (window.innerHeight > scr_item_height) {
				scr_item_point = window.innerHeight - scr_item_height / 2.9;
			}
